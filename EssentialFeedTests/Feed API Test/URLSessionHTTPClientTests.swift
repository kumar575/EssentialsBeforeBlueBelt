...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    private func resultFor(_ values: (Data?, response: URLResponse?, error: Error?)?, taskHandler: (HTTPClientTask) -> Void = { _ in }, file: StaticString = #file, line: UInt = #line) -> HTTPClient.Result {
